...
A version of this firmware is available at my gitlab repository[fn:20]. This
firmware was built using a custom ~Makefile~ system; it is possible to modify it
