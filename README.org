...
- On the same Linux you plan to run the node, you will need to run and keep the Agent, as presented
  in the section [[micro-ROS Agent]].
- This ping-pong application is released as a ROS2 Python node. It is best to pull and run it
  in a ROS2 environment to avoid having dependancies issues, as presented in the section [[Running a ROS2 node]].
...
** TODO Update the figures of the report
I should use the one used in the [[id:cdeec4c5-19d5-474e-b695-41bb64d3be50][SASIMI2024]] publication!
