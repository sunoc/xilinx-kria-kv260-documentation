...
This part is an alternative to the previous section [[Installing Linux (Ubuntu LTS
22.04 option)]], where the installation of PetaLinux as a host system[fn:24]
...
** COMMENT First login and configuration
