...
the figure \ref{fig:orgdb13acf} below.
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{img/recovery.png}
\caption{\label{fig:orgdb13acf}The recovery tool for the board, access from Firefox. We can see board information at the center, and the tools to upload the firmware at the bottom of the page.}
\end{figure}

\subsection{Updating the boot firmware}
\label{sec:org96378e8}
...
but also in this report appendix \ref{sec:orgcba7053}.
...
\label{sec:org2e37366}

\section{Loading a real-time firmware}
\label{sec:org806cc45}

\section{Running a ROS2 node}
\label{sec:org0832c89}

\subsection{On the host Linux}
\label{sec:org27bbe00}

\subsection{In a container}
\label{sec:org26db207}

\section{micro-ROS agent}
\label{sec:orga09bbe0}

\pagebreak
\appendix
\section{DTO patch}
\label{sec:orgcba7053}
...
\label{sec:org2cbfebb}

\subsection{main}
\label{sec:orgecb3967}
...
\label{sec:orga74ed70}

\subsection{main}
\label{sec:org709515c}
