...
the figure \ref{fig:org04aa675} below. If the page struggle to appear,
\end{itemize}
...
\caption{\label{fig:org04aa675}The recovery tool for the board, access from Firefox. We can see board information at the center, and the tools to upload the firmware at the bottom of the page.}
\end{figure}

\subsection{Updating the boot firmware}
\label{sec:org8ed8f8a}
