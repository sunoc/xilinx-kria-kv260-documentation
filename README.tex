...
the figure \ref{fig:org1a38ba6} below.
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{img/recovery.png}
\caption{\label{fig:org1a38ba6}The recovery tool for the board, access from Firefox. We can see board information at the center, and the tools to upload the firmware at the bottom of the page.}
\end{figure}

\subsection{Updating the boot firmware}
\label{sec:org182a1cd}
...
but also in this report appendix \ref{sec:org3e44ce2}.
...
\label{sec:org1cc3fd3}

\section{Loading a real-time firmware}
\label{sec:org6a40124}

\section{Running a ROS2 node}
\label{sec:org6fd6900}

\subsection{On the host Linux}
\label{sec:org501c0f3}

\subsection{In a container}
\label{sec:orgdad3e4d}

\section{micro-ROS agent}
\label{sec:org975f1f9}

\pagebreak
\appendix
\section{DTO patch}
\label{sec:org3e44ce2}
...
\label{sec:orgce939d5}

\subsection{main}
\label{sec:org4b826dd}
...
\label{sec:org74c11af}

\subsection{main}
\label{sec:orgb8126ca}
