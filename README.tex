...
the figure \ref{fig:orgbc0cc2f} below.
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{img/recovery.png}
\caption{\label{fig:orgbc0cc2f}The recovery tool for the board, access from Firefox. We can see board information at the center, and the tools to upload the firmware at the bottom of the page.}
\end{figure}

\subsection{Updating the boot firmware}
\label{sec:org383294f}
...
but also in this report appendix \ref{sec:orgf12bb0e}.
...
\subsection{Xilinx's Vitis IDE}
\label{sec:orgc6e5df1}

\section{RPMsg \texttt{echo\_test} software}
\label{sec:orgb5d6c85}
...
\label{sec:orge249209}

\section{Loading a real-time firmware}
\label{sec:orgb8e96b6}

\section{Running a ROS2 node}
\label{sec:orgc8885b7}

\subsection{On the host Linux}
\label{sec:org524ea9d}

\subsection{In a container}
\label{sec:orgc06df0d}

\section{micro-ROS agent}
\label{sec:orgb63ff2f}

\pagebreak
\appendix
\section{DTO patch}
\label{sec:orgf12bb0e}
...
\label{sec:org38f929a}

\subsection{main}
\label{sec:org1b77b4c}
...
\label{sec:org80833c1}

\subsection{main}
\label{sec:orga685b5c}
