...
the figure \ref{fig:org0210e57} below.
\end{itemize}

\begin{figure}[htbp]
\centering
\includegraphics[width=1\textwidth]{img/recovery.png}
\caption{\label{fig:org0210e57}The recovery tool for the board, access from Firefox. We can see board information at the center, and the tools to upload the firmware at the bottom of the page.}
\end{figure}

\subsection{Updating the boot firmware}
\label{sec:orgc335bcc}
...
up and running.\href{../dds-over-rpmsg-presentation/README.org}{DDS over RPMsg on HMP}
...
\label{sec:org508e0fe}

\subsection{main}
\label{sec:orgcc1ff4f}
...
\label{sec:org1225932}

\subsection{main}
\label{sec:org434a968}
