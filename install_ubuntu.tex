...
in the figure \ref{fig:orgeab6332} below, after the commands:
...
\caption{\label{fig:orgeab6332}The return of a successful run of the \texttt{hello world} test Docker container.}
\end{figure}

\subsection{[recommended] Purging \texttt{snap}}
\label{sec:org6e3b37e}
...
Eventually creating Notebooks and stuff, it is possible to obtain a situation like shown in the figure \ref{fig:org31dc01b} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textwidth]{img/jupyter.png}
\caption{\label{fig:org31dc01b}A test Jupyter Notebook for CSV data analysis.}
\end{figure}

\subsection{[TODO] Using a PetaLinux kernel in Ubuntu}
\label{sec:org548dcb6}
TBD

\section{RPMsg standalone evaluation}
\label{sec:org492cc0a}
\subsection{[TODO] RPMsg Cortex R5F demonstration firmware}
\label{sec:orgee3dec0}
\subsection{RPMsg \texttt{echo\_test} software}
\label{sec:orgdfa4bb2}
