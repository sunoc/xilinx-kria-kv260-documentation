...
Eventually creating Notebooks and stuff, it is possible to obtain a situation like shown in the figure \ref{fig:org3cc631c} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textwidth]{./img/jupyter.png}
\caption{\label{fig:org3cc631c}A test Jupyter Notebook for CSV data analysis.}
\end{figure}

\subsubsection{Enabling \texttt{remoteproc} with Device-Tree Overlay patching}
\label{sec:org4f39c4a}
...
but also in this report appendix \ref{sec:orgdeef376}.
...
in the figure \ref{fig:org9c5d93f} below, after the commands:
...
\caption{\label{fig:org9c5d93f}The return of a successful run of the \texttt{hello world} test Docker container.}
\end{figure}
