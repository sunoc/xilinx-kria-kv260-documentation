...
Eventually creating Notebooks and stuff, it is possible to obtain a situation like shown in the figure \ref{fig:org6f51987} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textwidth]{img/jupyter.png}
\caption{\label{fig:org6f51987}A test Jupyter Notebook for CSV data analysis.}
\end{figure}

\subsubsection{Enabling \texttt{remoteproc} with Device-Tree Overlay patching}
\label{sec:org63e3510}
...
but also in this report appendix \ref{sec:org88eb2dd}.
...
in the figure \ref{fig:orgd1b85ee} below, after the commands:
...
\caption{\label{fig:orgd1b85ee}The return of a successful run of the \texttt{hello world} test Docker container.}
\end{figure}

\subsubsection{Adding a swap partition}
\label{sec:org339b31f}
...
\label{sec:orgc8c018b}


\pagebreak
\appendix
\section{DTO patch}
\label{sec:org88eb2dd}
