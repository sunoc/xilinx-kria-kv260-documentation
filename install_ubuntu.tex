...
in the figure \ref{fig:org6df28c2} below, after the commands:
...
\caption{\label{fig:org6df28c2}The return of a successful run of the \texttt{hello world} test Docker container.}
\end{figure}

\subsection{[recommended] Purging \texttt{snap}}
\label{sec:org621d84b}
...
\label{sec:org883cdd5}
\subsubsection{Kernel \texttt{cmd} edit}
\label{sec:org944d8c0}
\begin{minted}[frame=single,framesep=2mm,baselinestretch=1.2,linenos,breaklines,fontsize=\footnotesize]{sh}
sudo nano /etc/default/flash-kernel
...
Eventually creating Notebooks and stuff, it is possible to obtain a situation like shown in the figure \ref{fig:org5166754} below.

\begin{figure}[htbp]
\centering
\includegraphics[width=.6\textwidth]{img/jupyter.png}
\caption{\label{fig:org5166754}A test Jupyter Notebook for CSV data analysis.}
\end{figure}

\subsection{[TODO] Using a PetaLinux kernel in Ubuntu}
\label{sec:orga6be693}
TBD

\section{RPMsg standalone evaluation}
\label{sec:org1266719}
\subsection{[TODO] RPMsg Cortex R5F demonstration firmware}
\label{sec:org09e7877}
\subsection{RPMsg \texttt{echo\_test} software}
\label{sec:orgf032811}
