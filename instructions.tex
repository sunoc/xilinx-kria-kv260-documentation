...
pushd /etc/ros/rosdep/sources.list.d && \
...
cp -r /armr5-toolchain/ $(pwd)/toolchain && \
...
\begin{itemize}
\item \verb|Package 'rcutils' exports library 'dl' which couldn't be found|: A warning that appears for almost every package. This warning is referenced in a \href{https://github.com/micro-ROS/freertos_apps/issues/37}{Issue ticket on micro-ROS GitHub page}. Need to investigate more since the issue is marked as closed, and seemed to have been solved by user ncnynl.
\item \verb|warning: array subscript has type 'char' [-Wchar-subscripts]|: No idea what's going on here.
\item \verb|warning: implicit declaration of function 'usleep';|, \verb|warning: implicit declaration of function 'clock_gettime'|: Normal, the time-related library will be added in the Vitis project.
...
docker cp ros_build:/microros_ws/firmware/build/libmicroros.a\
...
\begin{tcolorbox}
\begin{verbatim}
scp /home/sunoc/workspace/rpmsg_pingpong_microros_lib/Debug/rpmsg_pingpong_microros_lib.elf  kria:/home/ubuntu/
\end{verbatim}
\end{tcolorbox}
